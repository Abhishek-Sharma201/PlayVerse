  ...
  const games = [
    {
      ...
      description: 'The 1st place is bagged by Apex Legend developed by EA sports and has rapidly got some massive following among gaming players. You can team up with your friends and visit',
      link: '#',
    },
    {
      id: 2,
      ...
      description: 'The 2nd place is bagged by COD Warzone by Activision and is hard to miss out. Top players around the world are seen streaming it every day which goes to show you to boost your hard block in a fast-pacing fps game.',
      link: '#',
    },
    {
      id: 3,
      ...
      description: 'Yes, 3rd place is bagged by Fall guys. BR doesn\'t mean that they kill be shooting each other, Fall guys took a unique approach towards BR where hundreds of players competing to finish the race first wins the game.',
      link: '#',
    },
  ]
    ...
    <div className="min-h-screen bg-gray-900 p-6 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative">
        ...
        >
          ...
          />
          <div>
            <h2 className="text-white font-semibold">Puneet Superstar</h2>
        ...
        >
          Do you play games? If yes! your answer will definitely be yes in front of the cases. Today's gaming have revolutionized the gaming industry and especially battle royal games have gone viral! Here and definitely you have played one of them atleast for today I am going to show you top the battle royal games for regular.
        </motion.p>
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {games.map((game, index) => (
            ...
            >
              {/* Neon border effect */}
              <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-purple-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-xl" style={{ padding: '1px' }}>
